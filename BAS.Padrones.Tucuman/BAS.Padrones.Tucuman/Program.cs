...
string padronFileContent = "";
List<PadronRegistry> padron = new();

var padronFileStream = new FileStream("C:\\Users\\admin\\Documents\\Dev\\IIBB Tucuman\\Padrón Tucuman\\ACREDITAN.txt", FileMode.Open);
...
using (TextReader reader = new StreamReader(padronFileStream))
{
    ...
    {
        var registry = new PadronRegistry()
        {
